"""Dump corpus profile (entity extraction, co-occurrences, census) without running generation/filtering."""
...
print("Running prepare_context() (corpus fetch + entity extraction + linking)...")
...
print(f"\nCorpus profile dumped to {dump_path}")
print(f"  Entities: {dump['entity_count']}")
print(f"  Co-occurrences: {dump['entity_cooccurrence_count']}")
print(f"  Corpus pool size: {dump['corpus_pool_size']}")
print(f"  Seed chunks: {dump['seed_chunk_count']}")
